...
#set cuda if available (tested in free colab to 
...
Write in Polish.
"""
#Name of the file, path. I leave mounting gdrive a it is, so everyone can use and set proper path.
...
#define function for intervention generation
def generate(
    user_prompt,
    system_prompt=None,
    max_new_tokens=1000,
